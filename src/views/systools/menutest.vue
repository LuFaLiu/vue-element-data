  ...
  data() {
    ...
    return {
      ...
      customcontent: {
        ...
        elContainerCommonLayoutType: {
          type: 'elContainerCommonLayout'
        },
        elContainerType2: {
          tag: "span",
          text: "Example",
        ...
        elContainerExampleType: {
          type: 'elContainerExample'
        },
        elAvatarType1: {
          tag: "span",
          text: "Basic",
        ...
        elRadioWithBorderType: {
          type: 'elRadioWithBorder'
        },
        elCheckboxType1: {
          tag: "span",
          text: "Basic usage",
