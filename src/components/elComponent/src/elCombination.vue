            ...
            for(var i in item){
                if(i !== 'componentName' || i !== 'pageName'){
                    if(i == 'readonly'){
                        ...
                        if(componentNameParams == 'elskeleton' && i == 'loading'){
                            ...
                            */ 
                        ...
                        }else if(componentNameParams == 'elcascaderpanel' && i == 'options'){
                            if(item[i] == 'options6') {
                                item[i] = that.superParams.elcascader.options6
                            }
                            ...
                            if(item[i] == 'value1') {
                                ...
                                item[i] = that.superParams.elinput.value12
                            }   else if(item[i] == 'value13') {
                                item[i] = that.superParams.elinput.value13
                            }   else if(item[i] == 'value14') {
                                item[i] = that.superParams.elinput.value14
                            }   else if(item[i] == 'value15') {
                                item[i] = that.superParams.elinput.value15
                            }   else if(item[i] == 'value16') {
                                item[i] = that.superParams.elinput.value16
                            ...
                            if(item[i] == 'value1') {
                                ...
                                item[i] = that.superParams.elinputnumber.value2
                            }   else if(item[i] == 'value3') {
                                item[i] = that.superParams.elinputnumber.value3
                            }   else if(item[i] == 'value5') {
                                item[i] = that.superParams.elinputnumber.value5
                            }   else if(item[i] == 'value6') {
                                item[i] = that.superParams.elinputnumber.value6
                            }   else if(item[i] == 'value7') {
                            ...
                            }   else if(item[i] == 'props3') {
                                item[i] = that.superParams.elcascader.props3
                            }   else if(item[i] == 'props5') {
                                item[i] = that.superParams.elcascader.props5
                            }   else if(item[i] == 'props6') {
                                item[i] = that.superParams.elcascader.props6
                            } 
