...
export default {
    ...
    render(h) {
        ...
        if (node) {
            ...
            } else if (node.type == 'elContainerCommonLayout') {
                console.log("node.type == 'elContainerCommonLayout'");
                return (
                    <div class="elContainerCommonLayout">
                        <el-container>
            ...
            } else if (node.type == 'elContainerExample') {
                console.log("node.type == 'elContainerExample'");
                const item = {
                    date: '2016-05-02',
                    name: 'Tom',
                    address: 'No. 189, Grove St, Los Angeles'
                };
                var tableData = Array(20).fill(item)
                return (
                    <div class="elContainerExample">
